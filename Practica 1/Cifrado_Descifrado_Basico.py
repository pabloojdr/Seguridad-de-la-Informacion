...
# Creamos un mecanismo de (des)cifrado DES en modo CBC con una inicializacion IV (Se crea uno nuevo porque el de cifrado "guarda" estados, es decir, mantiene un estado con el IV pasado o algo así)
